...
const BQA_TRANSLATIONS = {
  ...
  it: {
    ...
    "index.hero.lede": "Appartamenti nel cuore del centro storico di Roma e ville nella suggestiva Valle d'Itria, tra trulli e ulivi secolari. Ogni indirizzo ha la sua storia da raccontare. Prenota direttamente con noi, senza intermediari.",
    "index.trust.rating": "4,83/5 su Airbnb – Guest Favorite a Trastevere",
    ...
    "index.about.lede": "Siamo Guido e Federica, e ci occupiamo personalmente di ogni dettaglio delle nostre strutture, per offrirvi esperienze di soggiorno indimenticabili.",
    "index.about.p1": "Standard elevati di igiene e comfort, grazie a esperti nelle pulizie",
    "index.about.p2": "Self check-in per un arrivo senza stress, a qualsiasi ora",
    "index.about.p3": "Disponibili 24/7 per assistervi con qualsiasi richiesta",
    "index.about.p4": "Pagamenti flessibili: bonifico bancario, carte di credito/debito (Visa, Mastercard, American Express), PayPal e Google Pay",
    "index.about.closing": "La cura nei dettagli è il nostro modo di dirvi benvenuti, per un viaggio che lasci ricordi indelebili.",
    ...
    "trastevere.gallery.thumb.alt": "BQA San Crisogono Apartments Rome-Trastevere",
    "trastevere.gallery.lightbox.title": "Galleria foto dell'appartamento",
    ...
    "flaminio.gallery.thumb.alt": "BQA Fracassini Rooms Rome-Flaminio",
    "flaminio.gallery.lightbox.title": "Galleria foto dell'appartamento",
    ...
    "masseriola.gallery.thumb.alt": "BQA La Masseriola Private Villa-Trullo",
    "masseriola.gallery.lightbox.title": "Galleria foto della villa",
    "masseriola.zona2.h2": "Vivi la Valle d'Itria",
    "masseriola.zona2.lede": "Siamo nel cuore della Valle d'Itria, tra trulli secolari e ulivi millenari, a pochi minuti da alcuni dei borghi più belli d'Italia: Alberobello con i suoi trulli patrimonio UNESCO, la candida Ostuni e la raffinata Locorotondo. Le spiagge della costa adriatica sono a circa 10 km, mentre le suggestive Grotte di Castellana e lo Zoo Safari di Fasano regalano un'esperienza indimenticabile anche alle famiglie con bambini.",
    "masseriola.zona2.btn": "Vedi altre foto del quartiere",
    "masseriola.zona2.thumb.alt": "Scorci della Valle d'Itria, Puglia",
    "masseriola.zona2.lightbox.alt": "Foto della Valle d'Itria, Puglia",
    "masseriola.zona2.lightbox.title": "Galleria foto della Valle d'Itria",
  ...
  en: {
    ...
    "index.hero.lede": "Apartments in the heart of Rome's historic center and villas in the enchanting Valle d'Itria, among trulli and centuries-old olive groves. Every address has its own story to tell. Book directly with us, no middlemen.",
    ...
    "index.about.lede": "We're Guido and Federica, and we personally take care of every detail of our properties, to offer you unforgettable stays.",
    "index.about.p1": "High hygiene and comfort standards, thanks to professional cleaning experts",
    "index.about.p2": "Self check-in for a stress-free arrival, at any hour",
    "index.about.p3": "Available 24/7 to assist with any request",
    "index.about.p4": "Flexible payments: bank transfer, credit/debit cards (Visa, Mastercard, American Express), PayPal and Google Pay",
    "index.about.closing": "Attention to detail is how we say welcome, for a trip that leaves unforgettable memories.",
    ...
    "trastevere.gallery.thumb.alt": "BQA San Crisogono Apartments Rome-Trastevere",
    "trastevere.gallery.lightbox.title": "Apartment photo gallery",
    ...
    "flaminio.gallery.thumb.alt": "BQA Fracassini Rooms Rome-Flaminio",
    "flaminio.gallery.lightbox.title": "Apartment photo gallery",
    ...
    "masseriola.gallery.thumb.alt": "BQA La Masseriola Private Villa-Trullo",
    "masseriola.gallery.lightbox.title": "Villa photo gallery",
    "masseriola.zona2.h2": "Live the Valle d'Itria",
    "masseriola.zona2.lede": "We're in the heart of the Valle d'Itria, among centuries-old trulli and ancient olive groves, just minutes from some of Italy's most beautiful villages: Alberobello with its UNESCO World Heritage trulli, the whitewashed town of Ostuni, and the refined Locorotondo. The Adriatic coast beaches are about 10 km away, while the striking Grotte di Castellana caves and Fasano's Zoo Safari make for an unforgettable experience, especially for families with children.",
    "masseriola.zona2.btn": "See more neighborhood photos",
    "masseriola.zona2.thumb.alt": "Views of the Valle d'Itria, Puglia",
    "masseriola.zona2.lightbox.alt": "Photo of the Valle d'Itria, Puglia",
    "masseriola.zona2.lightbox.title": "Valle d'Itria photo gallery",
