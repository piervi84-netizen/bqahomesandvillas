...
const BQA_TRANSLATIONS = {
  ...
  it: {
    ...
    "index.hero.lede": "Dal cuore autentico di Trastevere alle colline di ulivi della Valle d'Itria: ogni indirizzo BQA è scelto a mano, per soggiorni che raccontano il vero volto dell'Italia.",
