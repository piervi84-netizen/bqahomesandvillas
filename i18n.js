...
const BQA_TRANSLATIONS = {
  ...
  it: {
    ...
    "index.hero.h1": "Le chiavi di casa nostra, per il tuo soggiorno in Italia.",
    "index.hero.lede": "Tre indirizzi curati da BQA: due nel cuore di Roma, uno nella campagna di Castellana Grotte, in Puglia. Prenota direttamente con noi, senza intermediari.",
  ...
  en: {
    ...
    "index.hero.h1": "The keys to our home, for your stay in Italy.",
    "index.hero.lede": "Three addresses curated by BQA: two in the heart of Rome, one in the countryside of Castellana Grotte, Puglia. Book directly with us, no middlemen.",
